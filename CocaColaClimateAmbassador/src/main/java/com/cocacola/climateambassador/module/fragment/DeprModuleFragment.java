 ...
 */
public class DeprModuleFragment extends CaFragment {

    private ModuleJson mModule;

    public static DeprModuleFragment newInstance(ModuleJson aModule) {
        DeprModuleFragment fragment = new DeprModuleFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(mModule.getTitle().equals("Our 2020 Vision")) {
            ...
            view = inflater.inflate(R.layout.activity_module_old, container, false);
        }
