...
public class RefrigerationCaseActivity extends CaCaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.scroll_view).setBackgroundDrawable(getResources().getDrawable(R.drawable.bg_case_refrigeration));
        ((ImageView)findViewById(R.id.case_logo)).setImageResource(R.drawable.ic_cases_list_refrigeration);
